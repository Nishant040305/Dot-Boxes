static azb::TrainConfig make_7x8_config() {
    azb::TrainConfig cfg;
    ...
    // ── Inference ────────────────────────────────────────────
    cfg.num_workers           = 16;
    cfg.max_inference_batch   = 16;

    // ── Checkpoints ──────────────────────────────────────────
    cfg.keep_checkpoints = 5;        
    cfg.model_name       = "alphazero_7x8";
    cfg.model_dir        = "../models/_7x8";
    ...
    cfg.phases = {
        ...
        { "Bootstrap",    20, 200,  300, 10, 0.003f,  20, 1.0f, 0.50f },
        ...
        { "RegionRecog",  20, 400,  400, 12, 0.001f,  15, 1.0f, 0.35f },
        ...
        { "ChainTactics", 25, 600,  400, 15, 0.0005f, 12, 0.80f, 0.20f },
        ...
        { "Parity",       25, 800,  150,  18, 0.0002f, 8,  0.60f, 0.08f },
        ...
        { "Mastery",      20, 1000, 100,  20, 0.00005f,5,  0.40f, 0.02f },
    };
